              ...
              <div className="row g-4">
                <div className="col-lg-6">
                  <div className="border rounded">
                    <a href="#">
                      <img
                        src={require("../../assets/img/single-item.jpg")}
              ...
              <div className="row g-4 fruite">
                ...
                <div className="col-lg-12">
                  ...
                  <div className="d-flex align-items-center justify-content-start">
                    ...
                    >
                      <img
                        src={require("../../assets/img/featur-1.jpg")}
                        className="img-fluid rounded"
                        alt="Image"
                      />
                    </div>
                  ...
                  <div className="d-flex align-items-center justify-content-start">
                    ...
                    >
                      <img
                        src={require("../../assets/img/featur-2.jpg")}
                        className="img-fluid rounded"
                        alt=""
                      />
                    </div>
                  ...
                  <div className="d-flex align-items-center justify-content-start">
                    ...
                    >
                      <img
                        src={require("../../assets/img/featur-3.jpg")}
                        className="img-fluid rounded"
                        alt=""
                      />
                    </div>
                  ...
                  <div className="d-flex align-items-center justify-content-start">
                    ...
                    >
                      <img
                        src={require("../../assets/img/vegetable-item-4.jpg")}
                        className="img-fluid rounded"
                        alt=""
                      />
                    </div>
                  ...
                  <div className="d-flex align-items-center justify-content-start">
                    ...
                    >
                      <img
                        src={require("../../assets/img/vegetable-item-5.jpg")}
                        className="img-fluid rounded"
                        alt=""
                      />
                    </div>
                  ...
                  <div className="d-flex align-items-center justify-content-start">
                    ...
                    >
                      <img
                        src={require("../../assets/img/vegetable-item-6.jpg")}
                        className="img-fluid rounded"
                        alt=""
                      />
                    </div>
                ...
                <div className="col-lg-12">
                  <div className="position-relative">
                    <img
                      src={require("../../assets/img/banner-fruits.jpg")}
          ...
          <div className="vesitable">
            <div className="owl-carousel vegetable-carousel justify-content-center">
              ...
              <div className="border border-primary rounded position-relative vesitable-item">
                <div className="vesitable-img">
                  <img
                    src={require("../../assets/img/vegetable-item-1.jpg")}
                    className="img-fluid w-100 rounded-top"
                    alt=""
                  />
                </div>
              ...
              <div className="border border-primary rounded position-relative vesitable-item">
                <div className="vesitable-img">
                  <img
                    src={require("../../assets/img/vegetable-item-3.png")}
